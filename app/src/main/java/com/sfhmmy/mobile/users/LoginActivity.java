...
//    private UserLoginTask mAuthTask = null;
    ...
    // ---- UI references ----
    private AutoCompleteTextView mEmailView = null;  // Handler for email input field.
    private EditText mPasswordView          = null;  // Handler for pass input field.
    private View mProgressView              = null;  // Handler for progress icon.
    private View mCredentialsContainerView  = null;  // Handler for the wrapper that contains
                                                     // email/pass/loginButton.
    ...
    public void onSessionRestorationFailure(String error) {
        // When a session cannot be restored, prompt user to login.
        mCredentialsContainerView.setVisibility(View.VISIBLE);
        // Also, progress bar should be hidden.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView = (AutoCompleteTextView) findViewById(R.id.loginForm_email);
//        populateAutoComplete();

        mPasswordView = (EditText) findViewById(R.id.loginForm_password);
        ...
        Button mEmailSignInButton = (Button) findViewById(R.id.loginForm_signInButton);
        ...
        mCredentialsContainerView = findViewById(R.id.loginForm_credentialsWrapper);
        mProgressView = findViewById(R.id.loginForm_progress);
    ...
    protected void onStart() {
        ...
        // Ask for restoration of a possible previously saved user session.
        UserManager.getUserManager().asyncRestoreLastSession();
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        // This login activity must stop listening, because it's going to be destroyed.
...
// ---- Private Methods ----
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            // Disable credentials input, show a progress spinner and ask for login.
            allowCredentialsEditing(false);
            showProgress(true);
...
//            mLoginFormView.setVisibility(show ? View.GONE : View.VISIBLE);
    ...
    private void allowCredentialsEditing(boolean allow) {
        if (allow) {
