...
public class PresentationsFragment extends UserAwareFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        webView.loadUrl(getString(R.string.info_presentations_url));
    }
    ...
    public void onStart() {
        ...
        if (mTopListener != null) {
            mTopListener.updateTitle(getString(R.string.presentations_title));
        }
    }
