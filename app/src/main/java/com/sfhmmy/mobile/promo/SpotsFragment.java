...
public class SpotsFragment extends UserAwareFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        webView.loadUrl(getString(R.string.info_spots_url));
    }
    ...
    public void onStart() {
        ...
        if (mTopListener != null) {
            mTopListener.updateTitle(getString(R.string.spots_title));
        }
    }
